...
describe('GET /companies', function () {
	...
	// test query strings
	test('name query string', async function () {
	...
	test('minEmployees query string', async function () {
	...
	test('name, minEmployees, maxEmployees queries string', async function () {
		const resp = await request(app)
			.get(`/companies`)
			.query({ name: '2', minEmployees: 2, maxEmployees: 2 });
		expect(resp.body).toEqual({
			companies: [
				{
					handle: 'c2',
